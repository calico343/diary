...
(function($) 
{
	...
	var defaults = {
			...
			onDayLinkClick		: function(date) { return false; },
	...
	jQuery.J.DrawCalendar = function(dateIn)
	{
		...
		var monthNavName = jQuery('.MonthName', navRow);
		...
		if(defaults.navLinks.enableWeekView) { monthNavHead.append(weekLink); }
				...
				if (defaults.dragableEvents) {
                    dateBox.droppable({
                        ...
                        drop: function(e, ui) {
                            ...
                            var ev = ui.draggable.attr("id").split('_');
                            setNewDate(ev[1], $(this).attr("date"));
							return false;
                        }
                    });
                }
	...
	jQuery.J.ReplaceEventCollection = function(eventCollection) 
	{
		if(eventCollection) 
		{
			//alert(typeof(eventCollection));
			//alert(eventCollection);
